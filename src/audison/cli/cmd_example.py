...
请生成对应的 Python 代码实现。'''
    ...
    print("")
    print("测试攻击引擎:")
    print(f"  audison attack {code_path}")
    print("")
    print("测试跨审查:")
    print(f"  audison cross-examine {code_path} --requirement {req_path}")
    print("")
    print("测试溯源追踪:")
    print(f"  audison trace {code_path}")
    print("")
    print("Want to audit your own code?")
    print("  → Open Playground: https://wdnmd1265.github.io/audison/playground.html")
    print("  → Install CLI:     pip install --user audison && audison init")
